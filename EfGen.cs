...
namespace EntityFrameworkCorePractice
{
    class EfGen
    {
        GenericRepository<Book> repo = new GenericRepository<Book>();

        public void EfGenExecute()
        {
            Option();
            while (true)
            {
        ...
        public void BorrowBook()
        {
            ...
            var book = repo.GetAll().Where(x => x.Id == code).FirstOrDefault();
